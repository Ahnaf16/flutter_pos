...
class ShadCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveRowMainAxisAlignment =
        rowMainAxisAlignment ?? theme.cardTheme.rowMainAxisAlignment ?? MainAxisAlignment.spaceBetween;

    final effectiveRowCrossAxisAlignment =
        rowCrossAxisAlignment ?? theme.cardTheme.rowCrossAxisAlignment ?? CrossAxisAlignment.start;
    ...
    final effectiveColumnMainAxisAlignment =
        columnMainAxisAlignment ?? theme.cardTheme.columnMainAxisAlignment ?? MainAxisAlignment.start;

    final effectiveColumnCrossAxisAlignment =
        columnCrossAxisAlignment ?? theme.cardTheme.columnCrossAxisAlignment ?? CrossAxisAlignment.start;
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              if (child != null)
                Flexible(
                  child: Padding(padding: childPadding ?? Pads.zero, child: child),
                ),
