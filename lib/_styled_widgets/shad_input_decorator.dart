...
class ShadInputDecorator extends StatelessWidget {
  const ShadInputDecorator({super.key, this.child, this.label, this.error, this.description, this.decoration});
  ...
  Widget build(BuildContext context) {
    ...
    final effectiveFallbackToLabelStyle = effectiveDecoration.fallbackToLabelStyle ?? true;
    ...
    final effectiveErrorStyle = effectiveDecoration.errorStyle ?? defaultErrorStyle;
        ...
        if (description != null)
          Padding(
            ...
            child: DefaultTextStyle(
              style: effectiveDecoration.descriptionStyle ?? theme.textTheme.muted,
              child: description!,
            ),
          ),
        if (error != null)
